...
// Validate inputs
if (empty($amount) || empty($transaction_hash) || empty($wallet_address) || empty($pool)) {
    $res = [
        'status_code' => 0,
...
$insertQuery = "INSERT INTO other_pools (amount, transaction_hash, wallet_address, pool, created_on) VALUES ($amount, '$transaction_hash', '$wallet_address', '$pool', NOW())";
