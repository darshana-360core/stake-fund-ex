    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">NFT Report</h4>
            </div>
        </div>
         <div class="m-t-30">
                    ...
                    <div>
                        ...
                        <ul class="nav nav-tabs member-tab" role="tablist">
                            <li role="presentation" class="active"><a href="#all_members" aria-controls="all_members"
                                    role="tab" data-toggle="tab">NFT Report</a></li>
                        </ul>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="all_members">
                                <div class="search-form export-form">
                                    <form action="{{route('nftReport')}}" method="post" class="mb-0">
                                        @csrf
                                        <div class="form-row">
                                                        ...
                                                        <thead class="table-light">
                                                            <tr>
                                                               <!--  <th scope="col" class="border-0 fs-4 font-weight-medium ps-4">
                                                                ...
                                                                <th scope="col" class="border-0 fs-4 font-weight-medium">NFT TransactionHash</th>
                                                                <th scope="col" class="border-0 fs-4 font-weight-medium">Token Id</th>
                                                                <th scope="col" class="border-0 fs-4 font-weight-medium">NFT Address</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @foreach($data['data']['data'] as $key => $value)
                                                                <tr>
                                                                    ...
                                                                    <td>{{$value['nftTransactionHash']}}</td>
                                                                    <td>{{$value['tokenId']}}</td>
                                                                    <td>{{$value['nftAddress']}}</td>
