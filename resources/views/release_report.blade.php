    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Release Report</h4>
            </div>
        </div>
                    ...
                    <div>
                        ...
                        <ul class="nav nav-tabs member-tab" role="tablist">
                            <li role="presentation" class="active"><a href="#all_members" aria-controls="all_members"
                                    role="tab" data-toggle="tab">Release Report</a></li>
                        </ul>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="all_members">
                                <div class="search-form export-form">
                                    <form action="{{route('releaseReport')}}" method="post" class="mb-0">
                                        @csrf
                                        <div class="form-row">
                                            ...
                                            <div class="form-group">
                                                <select name="stype" class="form-control">
                                                    ...
                                                    <option value="static" @if(isset($data['stype'])) @if($data['stype'] == 'static') selected @endif @endif>Static</option>
                                                    <option value="dynamic" @if(isset($data['stype'])) @if($data['stype'] == 'dynamic') selected @endif @endif>Dynamic</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                               ...
                               <div class="export-section">
                                    <a href="{{ url()->current() }}?export=yes&start_date={{ request('start_date') }}&end_date={{ request('end_date') }}&refferal_code={{ request('refferal_code') }}&stype={{ request('stype') }}">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        @if($value['type'] == 'static')
                                                                            <span class="badge badge-success fs-4">Static</span>
                                                                        @elseif($value['type'] == 'dynamic')
                                                                            <span class="badge badge-danger fs-4">Dynamic</span>
                                                                        @endif
                                                                    </td>
                                                                </tr>
                                                                @php
                                                        ...
                                                        <div class="dataTables_paginate paging_simple_numbers" id="example_paginate">
                                                            <ul class="pagination">
                                                                @foreach($data['data']['links'] as $key => $value)
                                                                    @if($value['url'] != null)
                                                                        <li class="paginate_button page-item @if($value['active'] == "true") active @endif"><a href="{{$value['url']}}&start_date={{$data['start_date']}}&end_date={{$data['end_date']}}&refferal_code={{$data['refferal_code']}}&stype={{$data['stype']}}" aria-controls="example" data-dt-idx="1" tabindex="0" class="page-link"><?php echo $value['label']; ?></a></li>
                                                                    @endif
                                                                @endforeach
                                                            </ul>
                                                        </div>
