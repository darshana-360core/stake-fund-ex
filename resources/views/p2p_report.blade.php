    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">P2P Report</h4>
            </div>
        </div>
         <div class="m-t-30">
                    ...
                    <div>
                        ...
                        <ul class="nav nav-tabs member-tab" role="tablist">
                            <li role="presentation" class="active"><a href="#all_members" aria-controls="all_members"
                                    role="tab" data-toggle="tab">P2P Report</a></li>
                        </ul>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="all_members">
                                <div class="search-form export-form">
                                    <form action="{{route('p2p_Report_Search')}}" method="post" class="mb-0">
                                        @csrf
                                        <div class="form-row">
                                                    ...
                                                    <table class="table no-wrap user-table mb-0">
                                                        <thead class="table-light">
                                                            <tr>
                                                               <!--  <th scope="col" class="border-0 fs-4 font-weight-medium ps-4">
                                                                ...
                                                                <th scope="col" class="border-0 fs-4 font-weight-medium">Sender Member Code</th>
                                                                <th scope="col" class="border-0 fs-4 font-weight-medium">Reciever Member Code</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @foreach($data['data']['data'] as $key => $value)
                                                                <tr>
                                                                    <td>
                                                                        <h5 class="font-weight-medium mb-1">{{$value['amount']}}</h5>
                                                                        <!-- <a href="javascript:void(0);" class="font-14 text-muted"></a> -->
                                                                    </td>
                                                                    <td><span class="badge badge-inverse fs-4">{{$value['from_user_name']}}</span></td>
                                                                    <td><span class="badge badge-inverse fs-4">{{$value['to_user_name']}}</span></td>
                                                                    <td>
                                                                        @if($value['status'] == "1")
                                                                            Accepted
