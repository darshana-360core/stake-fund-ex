                    ...
                    <div class="p-lg-3 p-2">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="h5 fw-normal m-0 ms-4">Total Generated</div>
                            </div>
                            <div class="ms-auto">
                                <h2 class="display-7 mb-0">{{$data['total_generated']}}</h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-lg-3 p-2">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="h5 fw-normal m-0 ms-4">Total Roi Income</div>
                            </div>
                            <div class="ms-auto">
                                <h2 class="display-7 mb-0">{{$data['totalRoiIncome']}}</h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <ul class="nav nav-tabs member-tab" role="tablist">
                            <li role="presentation" class="active"><a href="#all_members" aria-controls="all_members"
                                    role="tab" data-toggle="tab">ROI Report</a></li>
                        </ul>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="all_members">
                                <div class="search-form export-form">
                                    <form action="{{route('roiReport')}}" method="post" class="mb-0">
                                        @csrf
                                        <div class="form-row">
                                            ...
                                            <div class="form-group">
                                                <select name="inc_type" class="form-control">
                                                    ...
                                                    <option value="ROI" @if(isset($data['inc_type'])) @if($data['inc_type'] == 'ROI') selected @endif @endif>ROI</option>
                                                    <option value="Level" @if(isset($data['inc_type'])) @if($data['inc_type'] == 'Level') selected @endif @endif>Level ROI</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                ...
                                <div class="export-section">
                                    <a href="{{ url()->current() }}?export=yes&start_date={{ request('start_date') }}&end_date={{ request('end_date') }}&refferal_code={{ request('refferal_code') }}&inc_type={{ request('inc_type') }}">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table no-wrap user-table mb-0">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @endforeach
                                                            <tr>
                                                                <td><h3>Total : {{$data['totalSum']}}</h3></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                        ...
                                                        <div class="dataTables_paginate paging_simple_numbers" id="example_paginate">
                                                            <ul class="pagination">
                                                                @foreach($data['data']['links'] as $key => $value)
                                                                    @if($value['url'] != null)
                                                                        <li class="paginate_button page-item @if($value['active'] == "true") active @endif"><a href="{{$value['url']}}&start_date={{$data['start_date']}}&end_date={{$data['end_date']}}&refferal_code={{$data['refferal_code']}}&inc_type={{$data['inc_type']}}" aria-controls="example" data-dt-idx="1" tabindex="0" class="page-link"><?php echo $value['label']; ?></a></li>
                                                                    @endif
                                                                @endforeach
                                                            </ul>
                                                        </div>
