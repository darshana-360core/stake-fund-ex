    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Bonanza Form Details Report</h4>
            </div>
        </div>
                    ...
                    <div>
                        ...
                        <ul class="nav nav-tabs member-tab" role="tablist">
                            <li role="presentation" class="active"><a href="#all_members" aria-controls="all_members"
                                    role="tab" data-toggle="tab">Bonanza Form Details Report</a></li>
                        </ul>
                                ...
                                <div class="search-form export-form">
                                    <form action="{{route('stablebonnds_userdetail_report_process')}}" method="post" class="mb-0">
                                        ...
                                        <div class="export-section">
                                            <a href="https://defi.orbitx.world/exports/bonanzaa_report.csv?v={{time()}}" download="download"><button type="button" class="btn waves-effect waves-light btn-info">Export excel</button></a>
                                        </div>
                                    </form>
                                </div>
                                <!-- <div class="export-section">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @foreach($data['data']['data'] as $key => $value)
                                                                <tr>
                                                                    ...
                                                                    <td><a href="{{asset('storage/'.$value['passport_pic_front'])}}" target="_blank">View</a></td>
                                                                    <td><a href="{{asset('storage/'.$value['passport_pic_back'])}}" target="_blank">View</a></td>
