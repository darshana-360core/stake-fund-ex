...
<section class="w-full p-3 md:p-8 mx-auto max-w-[1400px]">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-5 xl:grid-cols-5 gap-5">
        ...
        <div class="text-center cursor-pointer">
            ...
            <span class="text-xl">${{number_format($data['user']['direct_income'] + $data['user']['roi_income'] + $data['user']['level_income'] + $data['user']['reward'] + $data['user']['royalty'], 2)}}</span>
        </div>
    </div>
            ...
            <div class="relative border-t border-[#1d2753] pt-4 leading-normal font-light">
                ...
                <form class="relative" method="post" action="{{route('fwithdrawProcess')}}" id="withdraw-process-form">
                    ...
                    <div class="relative">
                        ...
                        <p class="block text-xs text-white text-opacity-70 font-medium mb-2" id="minamount" >Error here</p>
                    </div>
                    <!-- Admin Fees -->
                    <div class="relative">
